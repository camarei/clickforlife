...
abstract class ViewModel {
	...
	/**
	 * Factory method for ViewModel views. Accepts a template path and an
	 * optional array of partial paths.
	 *
	 * @param   string  template path
	 * @param   array   partial paths
	 * @return  ViewModel
	 * @throws  Exception  if the view class does not exist
	 */
	 ...
	 * @param   array   partial paths
	 * @return  void
	 * @uses    ViewModel::template
	 * @uses    ViewModel::partial
	 */
	...
	/**
	 * Magic method, returns the output of [ViewModel::render].
	 *
	 * @return  string
	 * @uses    ViewModel::render
	 */
	...
	{
		return $this->_stash($this->_partials)->render();
	}
	 ...
	 * @param   ViewModel  view object
	 * @param   array     partial templates
	 * @return  Mustache
	 */
	protected function _stash(array $partials)
	{
	...
	{
		$file = APPPATH . 'templates/' . $path . '.mustache';
